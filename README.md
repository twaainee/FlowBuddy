...
[https://flowbuddy.vercel.app/favicon.ico](https://flowbuddy.vercel.app/favicon.ico)
...
🔗 **Live Demo**: [flowbuddy.vercel.app](https://flowbuddy.vercel.app)📁 **Repository**: [github.com/twaainee/FlowBuddy](https://github.com/twaainee/FlowBuddy)
...
*   **Text Correction Tips** – Actionable suggestions like _“Bend your front knee more”_ or _“Keep your back straight”_.
...
TechnologyPurpose**HTML5 / CSS3 / JavaScript**Core structure, styling, and logic**MediaPipe Pose (TensorFlow.js)**Real-time 33-point body landmark detection**WebRTC (getUserMedia)**Webcam access**LocalStorage / IndexedDB**Store session history and progress data**Vercel**Hosting and deployment
...
1.  bashgit clone https://github.com/twaainee/FlowBuddy.gitcd FlowBuddy
...
Plain textANTLR4BashCC#CSSCoffeeScriptCMakeDartDjangoDockerEJSErlangGitGoGraphQLGroovyHTMLJavaJavaScriptJSONJSXKotlinLaTeXLessLuaMakefileMarkdownMATLABMarkupObjective-CPerlPHPPowerShell.propertiesProtocol BuffersPythonRRubySass (Sass)Sass (Scss)SchemeSQLShellSwiftSVGTSXTypeScriptWebAssemblyYAMLXML`   # Using Python 3  python -m http.server 8000  # Using Node.js (if you have http-server installed)  npx http-server   `
...
1.  **Home Page** – Read the privacy notice and click _“Begin Flow”_.
...
Plain textANTLR4BashCC#CSSCoffeeScriptCMakeDartDjangoDockerEJSErlangGitGoGraphQLGroovyHTMLJavaJavaScriptJSONJSXKotlinLaTeXLessLuaMakefileMarkdownMATLABMarkupObjective-CPerlPHPPowerShell.propertiesProtocol BuffersPythonRRubySass (Sass)Sass (Scss)SchemeSQLShellSwiftSVGTSXTypeScriptWebAssemblyYAMLXML`   FlowBuddy/  ├── index.html              # Home / Landing page  ├── practice-select.html    # Pose selection screen  ├── insession.html          # Main practice session with camera & feedback  ├── progress.html           # Session history & alignment scores  ├── privacy.html            # Privacy policy (detailed on-device processing note)  ├── css/                    # Stylesheets  ├── js/                     # JavaScript modules (MediaPipe integration, angle calculations)  ├── assets/                 # Images, icons, pose reference images  └── README.md               # This file   `
...
This project is licensed under the **MIT License** – see the [LICENSE](https://LICENSE) file for details.You are free to use, modify, and distribute this software for personal or commercial purposes, as long as you include the original copyright notice.
...
**Developer**: Elijah Twaine Marquez**GitHub**: [@twaainee](https://github.com/twaainee)**Project Link**: [https://github.com/twaainee/FlowBuddy](https://github.com/twaainee/FlowBuddy)

⭐ **If you find this project useful, please give it a star on GitHub!**🧘‍♀️ _Flow with confidence. Your form improves every breath._
